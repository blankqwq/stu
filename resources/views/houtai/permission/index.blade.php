...
@section('permissions-index','active')
@section('content')
                        ...
                        <form action="/admin/permissions" method="post">
                            <table class="table table-hover">
                                ...
                                @foreach($permissions as $permission)
                                    <tr>
                                        <td>
                                            <input type="checkbox" value="{{ $permission->id }}" name="ids[]"></td>
                                        <td>{{ $permission->name }}</td>
                                        <td>{{ $permission->disply_name }}</td>
                                        <td>{{ $permission->description }}</td>
                                        <td>{{ $permission->created_at }}</td>
                                        <td>{{ $permission->updated_at }}</td>
                                        <td><a href="/admin/permissions/{{ $permission->id }}" id="read"><span
                            ...
                            <div class="box-footer">
                                <button class="btn btn-google btn-sm " type="submit">删除权限</button>
                                <button onclick="$('#users-content').empty();" type="button"
                                        class="btn btn-facebook btn-sm " data-toggle="modal" data-target="#myModal">创建权限
                                </button>
                                <!-- 模态框（Modal） -->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="display_name" placeholder="别名"
                                           name="display_name">
                                </div>
