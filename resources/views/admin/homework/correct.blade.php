                        ...
                        @forelse ($stuhomeworks as $stuhomework)
                            <tr>
                                ...
                                <td class="mailbox-subject"><b><a
                                                href="/classhome/{{ $classe->id }}/homework/{{ $stuhomework->id }}"
                                                id="read">{{$stuhomework->homeworks->title}}</a></b>
                                <td class="mailbox-subject"><b><a
                                                href="/classhome/{{$classe->id}}/homework/{{$stuhomework->homeworks->id }}"
                                                id="read">{!!  mb_substr(strip_tags($stuhomework->content),0,30) !!}</a></b>
                                </td>
                                <td>
                                ...
                                <td>{{$stuhomework->stuser->email}} [{{$stuhomework->stuser->getinfo->name}}]</td>
                                <td>
                                    @ability('admin,owner,teacher,class'.$classe->id, 'edit-homework,manage-homework')
                                    <a href="/classhome/{{ $classe->id }}/homework/correct/{{ $stuhomework->homeworks->id }}/{{$stuhomework->id}} "
