        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{$userinfo->name}}用户文件</h3>
                        <div class="box-tools">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <form action="/classes/deluser/" method="post">
                            ...
                            <div class="box-footer">
                                ...
                                @if(isset($parent))
                                <a href="@if($parent>0){{'/filesystem/'.$parent}}@else /filesystem @endif" class="btn btn-google btn-sm ">返回上一级目录</a>
                                @endif
                                <!-- 模态框（Modal） -->
            ...
            <div class="modal fade" id="myModa2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <form action="/filesystem/update/file/@if(isset($id)){{$id}}@else{{0}}@endif" method="post"
            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog">
                    <form action="/filesystem/new/folder/@if(isset($id)){{$id}}@else{{0}}@endif" method="post"
                          enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="modal-content">
                            <div class="modal-header">
