        ...
        <div class="row">
            ...
            <div class="box">
                <div class="box-body box-profile">
                    ...
                    <h3 class="profile-username text-center">姓名：{{ $user_info->name }}</h3>

                    <p class="text-muted text-center">个性签名：{{ $user_info->sign }}</p>

                    <p class="text-muted text-center">性别：{{ $user_info->sex }}</p>

                    <p class="text-muted text-center">邮箱地址：{{ $users->email }}</p>
                    ...
                    @if(\Illuminate\Support\Facades\Auth::id() === $users->id or \Illuminate\Support\Facades\Auth::user()->can('manage-user'))
